...
//this method get the locations and we are only storing the label, icons and url and showing it on the html page.
  getVenues() {
    ...
    if (this.recipeValue !== null) {
      this._http.get("https://api.edamam.com/search?q=" +this.recipeValue + "&app_id=8b488567&app_key=e20804ec93c2f7f87bd562edc4412512&to=5")
...
//for the location search we are limiting the location to 8 results
    if (this.placeValue != null && this.placeValue !== '' && this.recipeValue != null && this.recipeValue !== '') {
      this._http.get("https://api.foursquare.com/v2/venues/search?client_id=VHJX0AOJERFM02TZEAXP5L2BFDMNSF50HZKHTIB4AONKSSFN" +
          "&client_secret=KEDK24O1DK2IXH15NTQ42JHH2JJQJP3VY24PSH0I02U3CD44&v=20180323&limit=8&near=" +this.placeValue).subscribe((result: any) => {
        console.log(result);
